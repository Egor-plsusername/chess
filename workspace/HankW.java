...
public class HankW extends Piece {
  
  public HankW(boolean isWhite, String img_file) {
  ...
  // Pre Con: Board is valid, Start valid square in b startRow and startCol valid
  // places,
